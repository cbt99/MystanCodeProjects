...
def get_best_pixel(pixels):
    ...
    for pixel in pixels:   # pixels (a list)
        color_distance = get_pixel_dist(pixel, avg_r, avg_g, avg_b)    # not get_pixel_dist(pixel)
        if first_data is True:    # if first_data == True:
